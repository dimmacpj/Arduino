...
//constructors:
MyStepper::MyStepper(int apin, int bpin, int cpin, int dpin){
...
//movement setter:
void MyStepper::setSteps(int total_steps){
...
//move speed setter:
void MyStepper::setSpinSpeed(int spin_speed_phase){
  this->spin_speed_phase = spin_speed_phase;
}

//step pace setter:
void MyStepper::setPace(int spin_speed_step){
  this->spin_speed_step = spin_speed_step;
}

//make it moving:
void MyStepper::makeMove(void){
...
//turn on the phase:
void MyStepper::run(int current_phase){
